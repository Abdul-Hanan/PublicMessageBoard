...
<head>
<title>Client Advance Account :: Raseel</title>
							...
							<div class="row align-items-center">
								<div class="col-md-12">
									<div class="page-header-title">
										<h5 class="m-b-10">Client Advance Accounts</h5>
									</div>
									<ul class="breadcrumb">
										<li class="breadcrumb-item"><a href="#"><i
												class="feather icon-home"></i></a></li>
										<li class="breadcrumb-item"><a href="#!">Client Advance
												Accounts</a></li>
									</ul>
								</div>
							</div>
									...
									<div class="card">
										<div class="card-header">
											<div class="card-header"
												...
												<form action="${contextPath}/clientAdvance" method="POST">
										...
										<div class="card-block">
												...
												<!-- <a onclick="addCounterEntry();" style="color: black"
													...
													data-cont="forms">Client Advance</a> -->
													</div> 
			...
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					<div class="modal-header" style="background-color: #748892;">
						<h6 style="color: white">Client Advance</h6>
						<button type="button" style="color: white" class="close"
							data-dismiss="modal">&times;</button>

					</div>
					<div class="modal-body">
						<form action="${contextPath}/settleClientAdvance" method="post">                  							
										 <div class="row">
