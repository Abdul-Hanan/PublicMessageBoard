...
<head>
<title>Cash to Bank Deposits :: Raseel</title>
							...
							<div class="row align-items-center">
								<div class="col-md-12">
									<div class="page-header-title">
										<h5 class="m-b-10">Cash to Bank Deposits</h5>
									</div>
									<ul class="breadcrumb">
										<li class="breadcrumb-item"><a href="#"><i
												class="feather icon-home"></i></a></li>
										<li class="breadcrumb-item"><a href="#!">Cash to Bank Deposits</a></li>
									</ul>
								</div>
							</div>
						</div>
									...
									<div class="card">
										<div class="card-header">
											<div class="card-header"
												...
												<form action="${contextPath}/cashToBankDeposit" method="POST">
										...
										<div class="card-block">
												...
												<c:if test="${not empty cashRaseelEntries}">
 ...
 -->																<th>Date</th>						
															...
															<c:set var="credittotal" value="0" scope="page" />
																<c:forEach varStatus="loop" var="cashEntry"
																	items="${cashRaseelEntries}">
																	<tr>
																		<%-- <td><input type="checkbox"
																			name="selectedEntries[]" class="selectedEntries"
																			value="${cashEntry.entryId}" class="selects"></td> --%>
																		<td>${cashEntry.entryDate}</td>
																		<td>${cashEntry.posting.shipmentId!=0? cashEntry.posting.shipmentId:''}</td>
