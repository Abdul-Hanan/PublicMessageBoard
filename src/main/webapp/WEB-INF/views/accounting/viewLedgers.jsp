                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Ledgers</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Raseel Ledgers</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage Raseel Ledgers</h5>
                                        <div class="card-header-right">
                                          <%--   <sec:authorize access="hasAuthority('create-ledger')">
                                                <button type="button" onclick="location = 'ledger'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Ledger Type">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="ledger" items="${ledgers}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>                                                     
                                                        <td>${ledger.name}</td>
                                                        <td>${ledger.description}</td>
                                                        <td>
                                                           <sec:authorize access="hasAuthority('view-ledgerPostings')">
                                                                <a href="${contextPath}/ledgerPostings?ledgerId=${ledger.id}" class="btn btn-sm btn-rounded btn-outline-primary" data-cont="forms">                                                           
                                                                    Postings</a>
                                                            </sec:authorize>
                                                        </td>
                                                        <td>
                                                           <%--  <sec:authorize access="hasAuthority('edit-ledger')">
                                                                <a href="${contextPath}/ledger?id=${ledger.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize> --%>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
