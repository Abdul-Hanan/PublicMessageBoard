...
<head>
    <title>Account Types :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Raseel Account Types</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage Raseel Account Types</h5>
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-accountType')">
                                                <button type="button" onclick="location = 'accountType'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Account Type">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="accountType" items="${accountTypes}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>                                                     
                                                        <td>${accountType.accountTypeName}</td>
                                                        <td>${accountType.accountTypeDescription}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-accountType')">
                                                                <a href="${contextPath}/accountType?id=${accountType.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
