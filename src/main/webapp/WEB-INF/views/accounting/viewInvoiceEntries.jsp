...
<head>
<title>Create Invoice :: Raseel</title>
														...
														<table id="driverEntriesTable"
															...
															<c:set var="total" value="0" scope="page" />
																...
																<c:forEach varStatus="loop" var="driverEntry"
																	items="${receiveableRaseelEntries}">
																	<tr>
