...
<head>
    <title>	Service Types :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Service Types</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">View Service types</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-serviceType')">
                                                <button type="button" onclick="location = 'serviceType'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Service Type"><i class="feather icon-plus"></i></button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="serviceType" items="${serviceTypes}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${serviceType.name}</td>
                                                        <td>${serviceType.description}</td>
                                                        <td>${serviceType.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-serviceType')">
                                                                <a href="${contextPath}/serviceType?id=${serviceType.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
