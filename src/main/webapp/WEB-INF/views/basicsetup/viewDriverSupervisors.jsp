...
<head>
    <title>Driver Supervisors :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Driver Supervisors</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Driver Supervisors</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage Driver Supervisors</h5>
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="driverSupervisor" items="${driverSupervisors}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${driverSupervisor.contactFirstName} ${driverSupervisor.contactLastName}</td>
                                                        <td>${driverSupervisor.contactEmail}</td>
                                                        <td>${driverSupervisor.contactPhone}</td>
                                                        <td>${driverSupervisor.user.username}</td>
                                                        <td>${driverSupervisor.user.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-driverSupervisor')">
                                                                <a href="${contextPath}/driverSupervisor?id=${driverSupervisor.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
