                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Devices</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Raseel Devices</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage Raseel Devices</h5>
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-device')">
                                                <button type="button" onclick="location = 'device'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Device">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="device" items="${devices}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>                                                     
                                                        <td>${device.name}</td>
                                                        <td>${device.imei}</td>
                                                        ...
                                                        <td>${device.isactive eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-device')">
                                                                <a href="${contextPath}/device?id=${device.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
