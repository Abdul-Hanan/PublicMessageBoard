...
<head>
    <title>Transportation Partner :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Transportation Partners</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Transportation Partners</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Transportation Partners</h5>
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-transportationpartner')">
                                                <button type="button" onclick="location = 'transportationpartner'" class="btn btn-primary" title="" data-toggle="tooltip" data-original-title="Create a New Transportation partnet">New Partner</button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="transportationPartner" items="${transportationPartners}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${transportationPartner.companyName}</td>
                                                        <td>${transportationPartner.contactFirstName} ${transportationPartner.contactLastName}</td>
                                                        <td>${transportationPartner.contactEmail}</td>
                                                        <td>${transportationPartner.contactPhone}</td>
                                                        <td>${transportationPartner.feePerItem}</td>
                                                        <td>${transportationPartner.user.username}</td>
                                                        <td>${transportationPartner.user.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-transportationpartner')">
                                                                <a href="${contextPath}/transportationpartner?id=${transportationPartner.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
