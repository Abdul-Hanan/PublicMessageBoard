...
<head>
    <title>Payment Types :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Payment Types</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">View Payment types</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage Payment Types</h5>
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-paymentType')">
                                                <button type="button" onclick="location = 'paymentType'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Payment Type"><i class="feather icon-plus"></i></button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="paymentType" items="${paymentTypes}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${paymentType.name}</td>
                                                        <td>${paymentType.description}</td>
                                                        <td>${paymentType.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-paymentType')">
                                                                <a href="${contextPath}/paymentType?id=${paymentType.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
