...
<head>
    <title>	Shipment Types :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Shipment Types</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">View Shipment types</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage Shipment Types</h5>
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-shipmentType')">
                                                <button type="button" onclick="location = 'shipmentType'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Shipment Type"><i class="feather icon-plus"></i></button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="shipmentType" items="${shipmentTypes}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${shipmentType.name}</td>
                                                        <td>${shipmentType.description}</td>
                                                        <td>${shipmentType.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-shipmentType')">
                                                                <a href="${contextPath}/shipmentType?id=${shipmentType.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
