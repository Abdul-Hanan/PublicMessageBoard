                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Admins</h5>
                                </div>
                                <ul class="breadcrumb">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-admin')">
                                                <button type="button" onclick="location = 'admin'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Admin"><i class="feather icon-plus"></i></button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="admin" items="${admins}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${admin.contactFirstName} ${admin.contactLastName}</td>
                                                        <td>${admin.contactEmail}</td>
                                                        <td>${admin.contactPhone}</td>
                                                        <td>${admin.user.username}</td>
                                                        <td>${admin.user.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
