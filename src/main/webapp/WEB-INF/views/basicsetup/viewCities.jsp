                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">View Cities</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-city')">
                                                <button type="button" onclick="location = 'city'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New City">
                                            ...
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <c:forEach varStatus="loop" var="city" items="${cities}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${city.name}</td>
                                                        <td>${city.arabicName}</td>
                                                        <td>${city.description}</td>
                                                        <td>${city.country.name}</td>
                                                        <td>${city.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-city')">
                                                                <a href="${contextPath}/city?id=${city.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
