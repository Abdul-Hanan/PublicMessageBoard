                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Zones</h5>
                                </div>
                                <ul class="breadcrumb">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-zone')">
                                                <button type="button" onclick="location = 'zone'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Zone">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <form method="get" action="${contextPath}/zones">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select disabled class="form-control js-example-basic-single" id="locationType">
                                                                    <option disabled selected value="">Zone</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                            ...
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <c:forEach varStatus="loop" var="zone" items="${zone}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${zone.name} </td>
                                                        <td>${zone.arabicName} </td>
                                                        <td>${zone.address}</td>
                                                        <td>${zone.city.name}</td>
                                                        <td>${zone.country.name}</td>
                                                        <td>${zone.locationType.name}</td>
                                                        <td>${zone.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-zone')">
                                                                <a href="${contextPath}/zone?id=${zone.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
