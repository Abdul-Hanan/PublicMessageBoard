...
<head>
    <title>${edit eq true? 'Edit':'Create'} Station Partner :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">${edit eq true? 'Edit':'Create'} Station Partner</h5>
                                </div>
                                <ul class="breadcrumb">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>${edit eq true? 'Edit':'Create'} Station Partner</h5>
                                    </div>
                                    <div class="card-block row">
                                        <div class="col-md-8">
                                            <form action="${contextPath}/stationpartner" method="post">
                                                <input type="hidden" value="${stationPartner.id}" name="id">
                                                <input type="hidden" value="${stationPartner.user.id}" name="user.id">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="address">Company Name*</label>
                                                            <input name="companyName" value="${stationPartner.companyName}" type="text" required class="form-control" id="address" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="companyAddress">Company Address*</label>
                                                            <input name="companyAddress" value="${stationPartner.companyAddress}" type="text" required class="form-control" id="companyAddress" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="contactFirstName" value="${stationPartner.contactFirstName}" type="text" required class="form-control" id="contactFirstName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactLastName">Contact Last Name*</label>
                                                            <input name="contactLastName" value="${stationPartner.contactLastName}" type="text" required class="form-control" id="contactLastName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactEmail">Contact Email*</label>
                                                            <input name="contactEmail" value="${stationPartner.contactEmail}" type="text" required class="form-control" id="contactEmail" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactPhone">Contact Phone*</label>
                                                            <input name="contactPhone" value="${stationPartner.contactPhone}" type="text" required class="form-control" id="contactPhone" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="username">Login Name*</label>
                                                            <input name="user.username" value="${stationPartner.user.username}" type="text" required class="form-control" id="username" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="password">Password*</label>
                                                            <input name="user.password" value="${stationPartner.user.password}" type="text" required class="form-control" id="password" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" value="true" name="user.enabled" ${stationPartner.user.enabled ? 'checked':''} type="checkbox" id="gridCheck1">
