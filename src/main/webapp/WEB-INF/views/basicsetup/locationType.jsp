...
<head>
    <title>${edit eq true? 'Edit':'Create'} Location Type :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Location Type</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="${contextPath}/locationTypes">Location Types</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>${edit eq true? 'Edit':'Create'} Location Type</h5>
                                    </div>
                                    <div class="card-block row">
                                        <div class="col-md-8">
                                            <form action="${contextPath}/locationType" method="post">
                                                <input type="hidden" value="${locationType.id}" name="id">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactFirstName">Location Type Name*</label>
                                                            <input name="name" value="${locationType.name}" type="text" required class="form-control" id="contactFirstName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactLastName">Location Type Description</label>
                                                            <input name="description" value="${locationType.description}" type="text" required class="form-control" id="contactLastName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" value="true" name="enabled" ${locationType.enabled ? 'checked':''} type="checkbox" id="gridCheck1">
