                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">View Countries</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-country')">
                                                <button type="button" onclick="location = 'country'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Create a New Country"><i class="feather icon-plus"></i></button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="country" items="${countries}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${country.name}</td>
														<td>${country.arabicName}</td>
                                                        <td>${country.description}</td>
                                                        <td>${country.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-country')">
                                                                <a href="${contextPath}/country?id=${country.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
