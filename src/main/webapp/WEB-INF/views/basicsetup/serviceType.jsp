...
<head>
    <title>${edit eq true? 'Edit':'Create'} Service Type :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="${contextPath}/serviceTypes">Service Types</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>${edit eq true? 'Edit':'Create'} Service Type</h5>
                                    </div>
                                    <div class="card-block row">
                                        <div class="col-md-8">
                                            <form action="${contextPath}/serviceType" method="post">
                                                <input type="hidden" value="${serviceType.id}" name="id">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactFirstName">Service Type Name*</label>
                                                            <input name="name" value="${serviceType.name}" type="text" required class="form-control" id="contactFirstName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactLastName">Service Type Description</label>
                                                            <input name="description" value="${serviceType.description}" type="text" required class="form-control" id="contactLastName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" value="true" name="enabled" ${serviceType.enabled ? 'checked':''} type="checkbox" id="gridCheck1">
