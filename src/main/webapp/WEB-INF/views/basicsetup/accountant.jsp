...
<head>
    <title>${edit eq true? 'Edit':'Create'} Accountant :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Accountant</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="${contextPath}/accountants">Accountant</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>${edit eq true? 'Edit':'Create'} Accountant</h5>
                                    </div>
                                    <div class="card-block row">
                                        <div class="col-md-8">
                                            <form action="${contextPath}/accountant" method="post">
                                                <input type="hidden" value="${accountants.id}" name="id">
                                                <input type="hidden" value="${accountants.user.id}" name="user.id">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactFirstName">First Name*</label>
                                                            <input name="contactFirstName" value="${accountants.contactFirstName}" type="text" required class="form-control" id="contactFirstName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactLastName"> Last Name*</label>
                                                            <input name="contactLastName" value="${accountants.contactLastName}" type="text" required class="form-control" id="contactLastName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactEmail"> Email*</label>
                                                            <input name="contactEmail" value="${accountants.contactEmail}" type="text" required class="form-control" id="contactEmail" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="contactPhone"> Phone*</label>
                                                            <input name="contactPhone" value="${accountants.contactPhone}" type="text" required class="form-control" id="contactPhone" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="username">Login Name*</label>
                                                            <input name="user.username" value="${accountants.user.username}" type="text" required class="form-control" id="username" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="password">Password*</label>
                                                            <input name="user.password" value="${accountants.user.password}" type="text" required class="form-control" id="password" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" value="true" name="user.enabled" ${accountants.user.enabled ? 'checked':''} type="checkbox" id="gridCheck1">
