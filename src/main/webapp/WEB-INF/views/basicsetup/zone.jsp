...
<head>
    <title>${edit eq true? 'Edit':'Create'} Zone :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Raseel Zone</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="${contextPath}/zones">Zones</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>${edit eq true? 'Edit':'Create'} Zone</h5>
                                    </div>
                                    <div class="card-block row">
                                        <div class="col-md-10">
                                            ...
                                            <form method="post" action="${contextPath}/zone" >
                                                <input type="hidden" name="id" value="${zone.id}">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="officeName">Zone Name*</label>
                                                            <input type="text" name="name" value="${zone.name}" required class="form-control" id="officeName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="areaName">Arabic Name</label>
                                                            <input type="text" name="arabicName" value="${zone.arabicName}"  class="form-control" id="arabicName" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="officeAddress">Zone Description</label>
                                                            <input type="text" name="address" value="${zone.address}" class="form-control" id="officeAddress" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="latitude">Latitude*</label>
                                                            <input type="text" name="latitude" value="${zone.latitude}" required class="form-control" id="latitude" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="longitude">Longitude*</label>
                                                            <input type="text" name="longitude" value="${zone.longitude}" required class="form-control" id="longitude" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="longitude">Radius*</label>
                                                            <input type="text" name="raduis" value="${zone.raduis}" required class="form-control" id="raduis" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="locationType" class="form-control js-example-basic-single" required id="locationType">
                                                                ...
                                                                <c:forEach var="locationType" items="${locationTypes}">
                                                                    <option value="${locationType.id}" ${zone.locationType.id eq locationType.id ?'selected':''}>${locationType.name}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="country" class="form-control js-example-basic-single" required id="country">
                                                                ...
                                                                <c:forEach var="country" items="${countries}">
                                                                    <option value="${country.id}" ${zone.country.id eq country.id ?'selected':''}>${country.name}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="city" class="form-control js-example-basic-single" required id="city">
                                                                ...
                                                                <c:forEach var="city" items="${cities}">
                                                                    <option value="${city.id}" ${zone.city eq city ?'selected':''}>${city.name}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-check">
                                                            <input class="form-check-input" value="true" name="enabled" ${zone.enabled  ?'checked':''} type="checkbox" id="enabledCheck">
...
<script>
    ...
    function initMap() {
        ...
        <c:if test="${not empty zone.latitude}">
            var latlng = new google.maps.LatLng(${zone.latitude}, ${zone.longitude});
            circleObj.raduis = ${zone.raduis}
            placeMarker(latlng, map);
        </c:if>
        <c:if test="${empty zone.latitude}">
            circleObj.raduis = 500;
        </c:if>
...
//                circleObj.raduis = 500;
            ...
            google.maps.event.addListener(circle, 'dragend', function(){
                ...
                document
                    .getElementById('raduis').value = circleObj.raduis;
