                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Crowds</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Crowds</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <sec:authorize access="hasAuthority('create-crowd')">
                                                <button type="button" onclick="location = 'crowd'" class="btn btn-primary" title="" data-toggle="tooltip" data-original-title="Create a New Crowd">New Crowd</button>
                                            </sec:authorize>
                                        </div>
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="key-act-button" class="display table nowrap table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                <c:forEach varStatus="loop" var="crowd" items="${crowds}">
                                                    <tr>
                                                        <td>${loop.index+1}</td>
                                                        <td>${crowd.contactFirstName} ${crowd.contactLastName}</td>
                                                        <td>${crowd.contactEmail}</td>
                                                        <td>${crowd.address}</td>
                                                        <td>${crowd.feePerItem}</td>
                                                        <td>${crowd.user.username}</td>
                                                        <td>${crowd.user.enabled eq true ? 'Yes':'No'}</td>
                                                        <td>
                                                            <sec:authorize access="hasAuthority('edit-crowd')">
                                                                <a href="${contextPath}/crowd?id=${crowd.id}" class="text-left" data-cont="forms"><i class="feather feather icon-edit"></i></a>
                                                            </sec:authorize>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
