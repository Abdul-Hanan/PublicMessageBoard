...
<%--                                     <li class="breadcrumb-item"><a href="${contextPath}/shipments">Shipments</a></li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <button type="submit" onclick='printDiv();' class="btn btn-primary " title=""
                                                    data-toggle="tooltip"
                                            ...
                                            <div class="col-md-12" >
                                                <div class="row">
													<c:forEach var="shipment" items="${shipments}">
                                                        <div class="col-md-2">
                                                            <div id="qrCode${shipment}" class="center"></div>
                                                            <p style="padding-left: 30px;">Shipment Tracking #: ${shipment}</p>
                                                        </div>
                                                    </c:forEach>
                                                </div>
                                            </div>
...
<c:forEach var="shipment" items="${shipments}">
<script>
    var qrcode${shipment} = new QRCode(document.getElementById("qrCode${shipment}"), {
            text: "${shipment}",
            width: 128,
            height: 128,
            colorDark : "#000000",
