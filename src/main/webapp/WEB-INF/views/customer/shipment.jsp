...
<div class="col-md-12">
															...
															<div class="row" style="padding: 10px; border: solid 1px">
																...
																<div class="col-md-3">
																	<div class="form-group">
																		<label>Email*</label> <input class="form-control"
																			required id="receiverEmail" type="text" name="receiverEmail" value="${shipment.receiverEmail}"  />
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<label>Contact Number*</label> <input
																			list="receiverslist" class="form-control" required type="text" id="receiverContactNo"
																...
																<div class="col-md-3">
																	<div class="form-group">
																		<label>Secondary Contact Number</label> <input id="receiverSecondNumber"
																...
																<div class="col-md-12">
																	<div class="form-group">
																		<label>Full Address</label> <input value="${shipment.receiverAddress}"
																			class="form-control" required id="recieverAddress" type="text"
																...
																<div class="col-md-12">
																	<div class="form-group">
																		<label>Full Arabic Address</label> <input
																			class="form-control" required id="recieverArabicAddress" type="text" value="${shipment.receiverArabicAddress}"
...
<%-- 
 ...
 --%>
	...
	$('#receiverContactNo').on('change ', function() {
		...
		function processFormPickUpTime(){
