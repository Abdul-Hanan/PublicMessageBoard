...
<head>
    <title>	Version Control :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Version Control</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Versions</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Manage App Version</h5>
                                        <div class="card-header-right">
                                          <%--   <sec:authorize access="hasAuthority('create-status')"> --%>
                                                <button type="button" onclick="location = 'addVersion'" class="btn btn-primary btn-icon" title="" data-toggle="tooltip" data-original-title="Upload new Version"><i class="feather icon-plus"></i></button>
                                            <%-- </sec:authorize> --%>
                                        </div>
                                    </div>
												...
												<tbody>
													...
													<c:forEach items="${list}" var="version">
														<tr>
															...
															<td><c:out value="${version.isactive}" />&nbsp;</td>
															<td><c:if test="${version.isactive == 1}">
																	<b>Current Version</b>
																</c:if>
																<c:if test="${version.isactive != 1}">
																	<a href="activateVersion?id=${version.id}" class="btn btn-primary">Active</a>
																</c:if>
																</td>
														</tr>
