...
<!-- Favicon icon -->
<link rel="icon" href="${contextPath}/assets/images/favicon.ico"
	type="image/x-icon">
<!-- fontawesome icon -->
<link rel="stylesheet"
...
<!-- prism css -->
<link rel="stylesheet"
	href="${contextPath}/assets/plugins/prism/css/prism.min.css">
<!-- vendor css -->
								...
								<div class="col-sm-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="row">
												<div class="col-md-6">
													<form:form method="post" action="addVersion"
														modelAttribute="createUserForm"
														enctype="multipart/form-data">
														<form:hidden path="id" value="${createUserForm.id}" />
														<div class="form-group">
															<label for="name">Version Name</label> <input type="text"
																name="name" class="form-control" id="name"
																required placeholder="raseel-1.00.apk" >
														</div>

														<div class="form-group">
															<label for="file">Apk File</label> <input type="file"
