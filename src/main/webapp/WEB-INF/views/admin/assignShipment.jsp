...
<head>
    <title>Assign Shipment :: Raseel</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Assign Shipment</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <form action="assignShipment" method="POST">
                                      <div class="row" >
                                            <div class="col-md-12" >
                                                <div class="row">
													<div class="col-md-3">
																	<div class="form-group">
																		<label>Shipment#</label> <input
																			class="form-control" required type="text"
																			name="shipmentId" readonly
																			value="${shipment.id}" />
																	</div>
																</div>
																<div class="col-md-3">
																	<div class="form-group">
																		<label>Driver*</label> 
																		<select name="driver" class="form-control js-example-basic-single"  id="drivers"  required>
			                                                                <option disabled>Select Drivers</option>
			                                                                <c:forEach var="driver" items="${drivers}">
				                                                                <c:if test="${not empty assignedDriver}">
				   		                                                          <option value="${driver.id}" ${driver.id == assignedDriver.id ? 'selected="selected"' : ''} >${driver.user.username}</option>			                                                               
				                                                                </c:if>
				                                                                <c:if test="${empty assignedDriver}">
